...
Pre-release live monitoring found three missing CLOB prices for events 1005110, 1005106 and 1005114; Gamma confirmed all three events closed. Collection now checks up to five missing-price events per cycle and evicts only explicitly closed events/markets before versioning and saving the snapshot. Missing quotes without confirmed closure remain visible as partial-data errors. The database regression covers both cases and archive version changes.
